...
public class ARLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table AR_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_AR_LIBRARY";
    private static final String DATABASE_TABLE = "AR_LIBRARY";
    ...
    public ARLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS AR_LIBRARY");
            onCreate(db);
        }
        ...
        private void copyExcelDataToDatabase(SQLiteDatabase db) {
            ...
            try {
                InputStream is = mCtx.getResources().getAssets().open("farming_ARmaxoptions.xls");
    ...
    public ARLibraryDBAdapter open() throws SQLException {
