...
public class HolsterLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table Holster_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_Holster_LIBRARY";
    private static final String DATABASE_TABLE = "Holster_LIBRARY";
    ...
    public HolsterLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS Holster_LIBRARY");
            onCreate(db);
        }
    ...
    public HolsterLibraryDBAdapter open() throws SQLException {
