...
public class BRLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table BR_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_BR_LIBRARY";
    private static final String DATABASE_TABLE = "BR_LIBRARY";
    ...
    public BRLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS BR_LIBRARY");
            onCreate(db);
        }
        ...
        private void copyExcelDataToDatabase(SQLiteDatabase db) {
            ...
            try {
                InputStream is = mCtx.getResources().getAssets().open("farming_BRmaxoptions.xls");
    ...
    public BRLibraryDBAdapter open() throws SQLException {
