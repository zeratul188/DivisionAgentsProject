...
public class VestTalentDBAdapter {
    public static final String KEY_ROWID = "_id";
    public static final String KEY_NAME = "NAME";
    public static final String KEY_HAVE = "HAVE";

    private static final String DATABASE_CREATE = "create table VestTALENTLIBRARY (_id integer primary key, " +
            "NAME text not null, HAVE int not null);";

    private static final String DATABASE_NAME = "DIVISION_VestTALENTLIBRARY";
    private static final String DATABASE_TABLE = "VestTALENTLIBRARY";
    ...
    public VestTalentDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS VestTALENTLIBRARY");
            onCreate(db);
        }
    ...
    public VestTalentDBAdapter open() throws SQLException {
