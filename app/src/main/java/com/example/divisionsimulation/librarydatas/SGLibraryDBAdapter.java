...
public class SGLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table SG_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_SG_LIBRARY";
    private static final String DATABASE_TABLE = "SG_LIBRARY";
    ...
    public SGLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS SG_LIBRARY");
            onCreate(db);
        }
        ...
        private void copyExcelDataToDatabase(SQLiteDatabase db) {
            ...
            try {
                InputStream is = mCtx.getResources().getAssets().open("farming_SGmaxoptions.xls");
    ...
    public SGLibraryDBAdapter open() throws SQLException {
