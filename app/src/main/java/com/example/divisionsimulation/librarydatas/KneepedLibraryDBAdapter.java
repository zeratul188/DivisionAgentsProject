...
public class KneepedLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table Kneeped_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_Kneeped_LIBRARY";
    private static final String DATABASE_TABLE = "Kneeped_LIBRARY";
    ...
    public KneepedLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS Kneeped_LIBRARY");
            onCreate(db);
        }
    ...
    public KneepedLibraryDBAdapter open() throws SQLException {
