...
public class SRTalentDBAdapter {
    public static final String KEY_ROWID = "_id";
    public static final String KEY_NAME = "NAME";
    public static final String KEY_HAVE = "HAVE";

    private static final String DATABASE_CREATE = "create table SRTALENTLIBRARY (_id integer primary key, " +
            "NAME text not null, HAVE int not null);";

    private static final String DATABASE_NAME = "DIVISION_SRTALENTLIBRARY";
    private static final String DATABASE_TABLE = "SRTALENTLIBRARY";
    ...
    public SRTalentDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS SRTALENTLIBRARY");
            onCreate(db);
        }
    ...
    public SRTalentDBAdapter open() throws SQLException {
