...
public class GloveLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table Glove_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_Glove_LIBRARY";
    private static final String DATABASE_TABLE = "Glove_LIBRARY";
    ...
    public GloveLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS Glove_LIBRARY");
            onCreate(db);
        }
    ...
    public GloveLibraryDBAdapter open() throws SQLException {
