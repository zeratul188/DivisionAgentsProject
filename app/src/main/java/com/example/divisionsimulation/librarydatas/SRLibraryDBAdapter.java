...
public class SRLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table SR_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_SR_LIBRARY";
    private static final String DATABASE_TABLE = "SR_LIBRARY";
    ...
    public SRLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS SR_LIBRARY");
            onCreate(db);
        }
        ...
        private void copyExcelDataToDatabase(SQLiteDatabase db) {
            ...
            try {
                InputStream is = mCtx.getResources().getAssets().open("farming_SRmaxoptions.xls");
    ...
    public SRLibraryDBAdapter open() throws SQLException {
