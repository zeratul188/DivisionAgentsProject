...
public class BackpackLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table Backpack_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_Backpack_LIBRARY";
    private static final String DATABASE_TABLE = "Backpack_LIBRARY";
    ...
    public BackpackLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS Backpack_LIBRARY");
            onCreate(db);
        }
        ...
        private void copyExcelDataToDatabase(SQLiteDatabase db) {
            ...
            try {
                InputStream is = mCtx.getResources().getAssets().open("farming_Sheldmaxoptions.xls");
    ...
    public BackpackLibraryDBAdapter open() throws SQLException {
