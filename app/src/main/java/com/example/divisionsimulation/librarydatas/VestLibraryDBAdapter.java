...
public class VestLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table Vest_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_Vest_LIBRARY";
    private static final String DATABASE_TABLE = "Vest_LIBRARY";
    ...
    public VestLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS Vest_LIBRARY");
            onCreate(db);
        }
    ...
    public VestLibraryDBAdapter open() throws SQLException {
