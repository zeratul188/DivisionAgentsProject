...
public class BackpackTalentDBAdapter {
    public static final String KEY_ROWID = "_id";
    public static final String KEY_NAME = "NAME";
    public static final String KEY_HAVE = "HAVE";

    private static final String DATABASE_CREATE = "create table BackpackTALENTLIBRARY (_id integer primary key, " +
            "NAME text not null, HAVE int not null);";

    private static final String DATABASE_NAME = "DIVISION_BackpackTALENTLIBRARY";
    private static final String DATABASE_TABLE = "BackpackTALENTLIBRARY";
    ...
    public BackpackTalentDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS BackpackTALENTLIBRARY");
            onCreate(db);
        }
    ...
    public BackpackTalentDBAdapter open() throws SQLException {
