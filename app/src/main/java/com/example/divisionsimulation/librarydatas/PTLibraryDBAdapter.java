...
public class PTLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table PT_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_PT_LIBRARY";
    private static final String DATABASE_TABLE = "PT_LIBRARY";
    ...
    public PTLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS PT_LIBRARY");
            onCreate(db);
        }
        ...
        private void copyExcelDataToDatabase(SQLiteDatabase db) {
            ...
            try {
                InputStream is = mCtx.getResources().getAssets().open("farming_PTmaxoptions.xls");
    ...
    public PTLibraryDBAdapter open() throws SQLException {
