...
public class MaskLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table Mask_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_Mask_LIBRARY";
    private static final String DATABASE_TABLE = "Mask_LIBRARY";
    ...
    public MaskLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS Mask_LIBRARY");
            onCreate(db);
        }
    ...
    public MaskLibraryDBAdapter open() throws SQLException {
