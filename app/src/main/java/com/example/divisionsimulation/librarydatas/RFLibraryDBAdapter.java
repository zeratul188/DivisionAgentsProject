...
public class RFLibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table RF_LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_RF_LIBRARY";
    private static final String DATABASE_TABLE = "RF_LIBRARY";
    ...
    public RFLibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS RF_LIBRARY");
            onCreate(db);
        }
        ...
        private void copyExcelDataToDatabase(SQLiteDatabase db) {
            ...
            try {
                InputStream is = mCtx.getResources().getAssets().open("farming_RFmaxoptions.xls");
    ...
    public RFLibraryDBAdapter open() throws SQLException {
