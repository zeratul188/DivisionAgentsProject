...
public class MaxOptionsFMDBAdapter {
    ...
    public MaxOptionsFMDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS FARMING_MAXOPTION");
            onCreate(db);
        }
        ...
        private void copyExcelDataToDatabase(SQLiteDatabase db) {
            ...
            try {
                InputStream is = mCtx.getResources().getAssets().open("farming_maxoptions.xls");
    ...
    public MaxOptionsFMDBAdapter open() throws SQLException {
    ...
    public Cursor fetchSearchData(String content, String type) throws SQLException {
        Cursor cursor = sqlDB.query(true, DATABASE_TABLE, new String[] {KEY_ROWID, KEY_CONTENT, KEY_MAX, KEY_TYPE, KEY_ATTRIBUTE, KEY_TAIL}, KEY_CONTENT+"='"+content+"' and "+KEY_TYPE+"='"+type+"'", null, null, null, null, null);
        if (cursor != null) cursor.moveToFirst();
        return cursor;
    }
