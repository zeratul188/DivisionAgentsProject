...
public class LibraryDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table LIBRARY (_id integer primary key, " +
            "CONTENT text not null, MAX text not null, TYPE text, ATTRIBUTE text, TAIL text);";

    private static final String DATABASE_NAME = "DIVISION_LIBRARY";
    ...
    public LibraryDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
